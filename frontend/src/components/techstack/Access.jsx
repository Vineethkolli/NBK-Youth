...
const accessControl = {
  pages: {
    'Signin': { full: ['User', 'Admin', 'Financier'], view: [] },
    'Signup': { full: ['User', 'Admin', 'Financier'], view: [] },
