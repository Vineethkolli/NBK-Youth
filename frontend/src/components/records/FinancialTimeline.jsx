import { Edit2, Trash2, TrendingUp, TrendingDown, Minus, Calendar } from 'lucide-react';
  ...
  if (records.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-gray-400">Add financial data to see the timeline</p>
      </div>
    );
  }
              ...
              <div key={record._id} className="relative">
                ...
                <div className="ml-16">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-semibold text-gray-900">{record.year}</h3>
                    {isEditMode && (
