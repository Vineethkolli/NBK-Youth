      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            {visibleColumns.bill && <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Bill</th>}
            ...
            <tr key={expense._id}>
              ...
              {visibleColumns.bill && (
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  {expense.billImage ? (
                    <a href={expense.billImage} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">
                      View Bill
                    </a>
                  ) : (
                    'No Bill'
              ...
              {visibleColumns.paymentMode && <td className="px-6 py-4 whitespace-nowrap text-sm">{expense.paymentMode}</td>}
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className={`text-red-600 ${
                        isLocked || deletingId === expense._id ? 'opacity-50 cursor-not-allowed' : 'hover:text-red-900'
                      }`}
