...
function MaintenancePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-gray-200 flex items-center justify-center px-3">
      <div className="max-w-lg w-full bg-white rounded-lg shadow-2xl p-8 text-center transform transition-all duration-500 hover:scale-105">
        <div className="relative flex justify-center mb-6">
          ...
          <Wrench className="h-16 w-16 text-indigo-500 absolute -bottom-4 -right-4 transform rotate-45 animate-bounce" />
