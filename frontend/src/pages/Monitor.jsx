  ...
  return (
    <div className="max-w-1xl mx-auto space-y-6">
      <div className="bg-white border border-blue-200 rounded-xl shadow-md p-4 flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-indigo-800 mb-1">Backend Health Monitor</h2>
        </div>
        <a
          href="https://r4styp9l.status.cron-job.org/"
          target="_blank"
          rel="noopener noreferrer"
          className="px-5 py-2 bg-indigo-800 text-white rounded-lg font-medium hover:bg-indigo-700 transition-all"
        >
          Status
        </a>
      </div>
