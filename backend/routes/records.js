...
router.post('/financial', 
  auth, 
  checkRole(['developer']),
  recordsController.createFinancialRecord
);
router.put('/financial/:id', 
  auth, 
  checkRole(['developer']),
  recordsController.updateFinancialRecord
);
router.delete('/financial/:id', 
  auth, 
  checkRole(['developer']),
  recordsController.deleteFinancialRecord
);
...
router.post('/event-records',
  auth,
  checkRole(['developer']),
  upload.single('file'),
  recordsController.createEventRecord
);
...
router.delete('/event-records/:id',
  auth,
  checkRole(['developer']),
  recordsController.deleteEventRecord
);
