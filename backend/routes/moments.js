...
router.post('/upload', auth, checkRole(authRoles), momentController.uploadMediaMoment);
...
// Moment Media Routes
router.post('/:momentId/media', auth, checkRole(authRoles), momentMediaController.addMediaToMoment);
