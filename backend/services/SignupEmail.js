  ...
  try {
    ...
    const html = `
      ...
      <body style="margin:0; padding:0; word-spacing:normal; background-color:#f9fafb;">
        ...
        <!-- WRAPPER TABLE -->
<table role="presentation" cellpadding="0" cellspacing="0" width="100%" class="email-bg"
      ...
      <table role="presentation" align="center" width="600" cellpadding="0" cellspacing="0" class="email-container"
        ...
        <tr>
          <td align="center" class="header-td"
              style="background-color:#1a202c; padding:28px 24px;
              border-top-left-radius:12px; border-top-right-radius:12px;">
            <img src="${logoUrl}" width="80" height="80"
                 style="display:block;border-radius:50%; margin-bottom:14px;">
            <h1 style="margin:0; color:#ffffff;
              ...
              Welcome, ${name}
                ...
                <!-- BODY -->
                <tr>
                  <td style="padding:40px 30px; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
                    ...
                    <!-- BUTTON (Bulletproof Table Method for Outlook) -->
                      ...
                      <tr>
                        <td class="button-bg" style="border-radius: 8px; background-color: #d4a017; text-align: center;">
                          <a href="${baseUrl}" class="button-text" target="_blank" 
                             style="background-color: #d4a017; border: 1px solid #d4a017; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; color: #ffffff; padding: 14px 32px; text-decoration: none; display: inline-block; border-radius: 8px;">
                             🚀&nbsp;&nbsp;Visit NBK Youth
                          </a>
                        </td>
                      </tr>
                ...
                <!-- FOOTER -->
                <tr>
                  <td align="center" class="footer-td" style="background-color:#edf2f7; padding:24px;">
                    <p class="dark-text-gray" style="margin:0; color:#718096; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13px; line-height:1.6;">
                      © ${new Date().getFullYear()} Developed by <b>Kolli Vineeth</b><br>
